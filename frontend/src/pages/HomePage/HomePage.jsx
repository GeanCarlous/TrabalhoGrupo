    ...
    const fetchDisciplinas = async () => {
      try {
        const res = await fetch(
          `${process.env.REACT_APP_API_URL}/disciplinas`,
          {
  ...
  useEffect(() => {
    ...
    const fetchMaterials = async () => {
      ...
      if (submittedSearch) {
        ...
        params.append("orientador", submittedSearch);
      }
    ...
    <div className="home-page" style={{ touchAction: "pan-y" }}>
      ...
      <div className="sidebar">
        ...
        <nav className="nav-menu">
          ...
          <div
            className={`nav-item ${activeNav === "acervo" ? "active" : ""}`}
            onClick={() => setActiveNav("acervo")}
          >
            <svg className="nav-icon" viewBox="0 0 24 24" fill="currentColor">
              ...
              {selectedTag && (
                <div className="selected-tags">
                  <div className="tag-pill">
                    ...
                    <button className="tag-remove" onClick={clearFilter}>
                      <svg viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div className="card">
                          ...
                          <div className="card-content">
                            ...
                            <p className="uploader">
                              Enviado por:{" "}
                              {item.user_nome || "Utilizador Removido"}
                            </p>
