            ...
            <div className="material-card-body">
              ...
              <div className="material-info">
                <div className="info-item">
                  ...
                  <span>{material.orientador}</span>
                </div>
                <div className="info-row">
                  <div className="info-item">
                    <span className="info-label">Disciplina:</span>
                    <span className="subject-tag">{material.disciplina}</span>
                  </div>
                  <div className="info-item">
                    <span className="info-label">Tipo:</span>
                    <span className="tipo-text">{material.tipomaterial}</span>
                  </div>
                </div>
                <div className="info-item">
                  <span className="info-label">Data:</span>
                  <span>{material.dataobtencao}</span>
                </div>
                <div className="info-item">
                  <span className="info-label">Enviado por:</span>
                  <span>{material.user_nome || "Utilizador Removido"}</span>
                </div>
              </div>
